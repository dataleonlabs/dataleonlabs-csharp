    ...
    public async Task<T> Deserialize<T>(Threading::CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return await JsonSerializer
                ...
                ?? throw new DataleonlabsInvalidDataException("Response cannot be null");
        }
...
public sealed class HttpResponse<T> : global::Dataleonlabs.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::Dataleonlabs.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::Dataleonlabs.Core.HttpResponse
{
