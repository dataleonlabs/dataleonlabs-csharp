...
public sealed record class IndividualUpdateParams : ParamsBase
{
    ...
    public IndividualUpdateParamsPerson? Person
    {
        get
        {
            return JsonModel.GetNullableClass<IndividualUpdateParamsPerson>(
                this.RawBodyData,
                "person"
            );
        }
    ...
    public IndividualUpdateParamsTechnicalData? TechnicalData
    {
        get
        {
            return JsonModel.GetNullableClass<IndividualUpdateParamsTechnicalData>(
                this.RawBodyData,
                "technical_data"
            );
        }
...
public sealed record class IndividualUpdateParamsPerson : JsonModel
{
    ...
    public ApiEnum<string, IndividualUpdateParamsPersonGender>? Gender
    {
        get
        {
            return JsonModel.GetNullableClass<ApiEnum<string, IndividualUpdateParamsPersonGender>>(
                this.RawData,
                "gender"
            );
        }
