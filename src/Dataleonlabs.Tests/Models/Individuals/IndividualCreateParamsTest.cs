...
public class IndividualCreateParamsTest : TestBase
{
    [Fact]
    ...
    {
        var parameters = new IndividualCreateParams { WorkspaceID = "wk_123" };
...
public class PersonTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Person>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Person>(element, ModelBase.SerializerOptions);
...
public class GenderTest : TestBase
{
    [Theory]
    [InlineData(Gender.M)]
    [InlineData(Gender.F)]
    public void Validation_Works(Gender rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Gender> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Gender>>(
    ...
    [InlineData(Gender.M)]
    [InlineData(Gender.F)]
    public void SerializationRoundtrip_Works(Gender rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Gender> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Gender>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class TechnicalDataTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<TechnicalData>(
            json,
            ModelBase.SerializerOptions
        );
...
public class PortalStepTest : TestBase
{
    [Theory]
    [InlineData(PortalStep.IdentityVerification)]
    [InlineData(PortalStep.DocumentSigning)]
    [InlineData(PortalStep.ProofOfAddress)]
    [InlineData(PortalStep.Selfie)]
    [InlineData(PortalStep.FaceMatch)]
    public void Validation_Works(PortalStep rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PortalStep> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, PortalStep>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(PortalStep.Selfie)]
    [InlineData(PortalStep.FaceMatch)]
    public void SerializationRoundtrip_Works(PortalStep rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PortalStep> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, PortalStep>>(
            json,
            ModelBase.SerializerOptions
        );
